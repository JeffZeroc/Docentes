                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="facultad_id" id="facultad_id"
                                                    class="form-select form-control @error('facultad_id') is-invalid @enderror">
                                                    @foreach ($facultades as $facultad)
                                                        <option value="{{ $facultad->id }}"
                                                            @if (old('facultad_id') == null) @if ($facultad->id == $carrera->facultad_id)
                                                                    {{ 'selected' }} @endif
                                                        @else
                                                            @if ($facultad->id == old('facultad_id')) {{ 'selected' }} @endif
                                                            @endif>
                                                            {{ $facultad->nombre }}
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input id="nombre" type="text" name="nombre"
                                                    ...
                                                    value="{{ $carrera->nombre }}" placeholder="Nombre carrera" autofocus>
                                                @error('nombre')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="codigo" type="text" name="codigo"
                                                    ...
                                                    value="{{ $carrera->codigo }}" placeholder="Código Carrera" autofocus>
                                                @error('codigo')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="duracion" type="text" name="duracion"
                                                    ...
                                                    value="{{ $carrera->duracion }}" placeholder="1-11" autofocus>
                                                @error('duracion')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select name="estado" id="estado" class="form-control ">
                                                    <option value="Activo"
                                                        @if (old('estado') == null) @if ($carrera->estado == 'Activo')
                                                                {{ 'selected' }} @endif
                                                    @else
                                                    ...
                                                    <option value="Suspendido"
                                                        @if (old('estado') == null) @if ($carrera->estado == 'Suspendido')
                                                                {{ 'selected' }} @endif
                                                    @else
