                                                ...
                                                <select name="facultad_id" id="facultad_id"
                                                    ...
                                                    @foreach ($facultades as $facultad)
                                                        <option value="{{ $facultad->id }}"
                                                            {{ collect(old('facultad_id'))->contains($facultad->id) ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input id="nombre" type="text" name="nombre"
                                                    ...
                                                    value="{{ old('nombre') }}" placeholder="Nombre Carrera" autofocus>
                                                @error('nombre')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="codigo" type="text" name="codigo"
                                                    ...
                                                    value="{{ old('codigo') }}" placeholder="Código Carrera" autofocus>
                                                @error('codigo')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="duracion" type="text" name="duracion"
                                                    ...
                                                    value="{{ old('duracion') }}" placeholder="1-11" autofocus>
                                                @error('duracion')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <select name="estado" id="estado" class="form-control ">
                                                    ...
                                                    <option value="Activo"
                                                        @if (old('estado') == 'Activo') {{ 'selected' }} @endif>Activo
                                                    </option>
