                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class=" col-md-6">
                                            @if (Auth::user()->id == $user->id && $user->tipo == 'Administrador')
                                                <select id="tipo"
                                                    class="form-control @error('tipo') is-invalid @enderror form-select form-select-lg"
                                                    value="{{ $user->tipo }}" name="tipo">
                                            ...
                                            @else
                                                <select id="tipo"
                                                    ...
                                                    <option value="Administrador"
                                                        @if (old('tipo') == null) @if ($user->tipo == 'Administrador')
                                                                {{ 'selected' }} @endif
                                                    @else
                                                    ...
                                                    <option value="Colaborador"
                                                        @if (old('tipo') == null) @if ($user->tipo == 'Colaborador')
                                                                {{ 'selected' }} @endif
                                                    @else
