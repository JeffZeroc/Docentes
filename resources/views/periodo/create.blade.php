        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('periodos.store') }}" role="form"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="nombre" type="text" name="nombre"
                                                        ...
                                                        value="{{ old('nombre') }}" placeholder="Nombre Periodo Académico"
                                                        autofocus>
                                                    @error('nombre')
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="codigo" type="text" name="codigo"
                                                        ...
                                                        value="{{ old('codigo') }}" placeholder="Codigo Periodo Académico"
                                                        autofocus>
                                                    @error('codigo')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="inicio_periodo" type="date" name="inicio_periodo"
                                                        ...
                                                        value="{{ old('inicio_periodo') }}" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="fin_periodo" type="date" name="fin_periodo"
                                                        ...
                                                        value="{{ old('fin_periodo') }}" autofocus>
                                                    @error('fin_periodo')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="estado" id="estado" class="form-select form-control ">
                                                        <option value="1"
                                                            @if (old('estado') == '1') {{ 'selected' }} @endif>
                                                            Vigente</option>
                                                        <option value="0"
                                                            @if (old('estado') == '0') {{ 'selected' }} @endif>
                                                            Caducado</option>
                                                    </select>
                                                </div>
                                            </div>
