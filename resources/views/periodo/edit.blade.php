            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Actualizar Periodo Académico</span>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="nombre" type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" value="{{ $periodo->nombre }}" placeholder="Nombre Periodo Académico" autofocus>
                                                @error('nombre')
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="codigo" type="text" name="codigo" class="form-control @error('codigo') is-invalid @enderror" value="{{ $periodo->codigo }}" placeholder="Codigo Periodo Académico" autofocus>
                                                @error('codigo')
                                                    <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="estado" id="estado" class="form-select form-control "  >
                                                    <option value="1" @if ($periodo->estado == "1") {{ 'selected' }} @endif >Vigente</option>      
                                                    <option value="0" @if ($periodo->estado == "0") {{ 'selected' }} @endif >Caducado</option>                   
                                                </select>
                                            </div>
                                        </div>
                                    </div>
