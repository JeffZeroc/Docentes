                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="cedula" type="text" name="cedula"
                                                    ...
                                                    value="{{ old('cedula') }}" placeholder="Cedula de Identidad"
                                                    autofocus>
                                                @error('cedula')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="celular" type="text" name="celular"
                                                    ...
                                                    value="{{ old('celular') }}" placeholder="Número Telefonico"
                                                    autofocus>
                                                @error('celular')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="sexo" id="sexo" class="form-select form-control ">
                                                    ...
                                                    <option value="Hombre"
                                                        @if (old('sexo') == 'Hombre') {{ 'selected' }} @endif>Hombre
                                                    </option>
                                                    <option value="Mujer"
                                                        @if (old('sexo') == 'Mujer') {{ 'selected' }} @endif>Mujer
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="etnia" id="etnia" class="form-select orm-control ">
                                                    <option value="Mestizo"
                                                        @if (old('etnia') == 'Mestizo') {{ 'selected' }} @endif>
                                                        Mestizo</option>
                                                    <option value="Montubio"
                                                        @if (old('etnia') == 'Montubio') {{ 'selected' }} @endif>
                                                        Montubio</option>
                                                    <option value="AfroEcuatoriano"
                                                        @if (old('etnia') == 'AfroEcuatoriano') {{ 'selected' }} @endif>
                                                        AfroEcuatoriano</option>
                                                    <option value="Indígena"
                                                        @if (old('etnia') == 'Indígena') {{ 'selected' }} @endif>
                                                        Indígena</option>
                                                    <option value="Blanco"
                                                        @if (old('etnia') == 'Blanco') {{ 'selected' }} @endif>
                                                        Blanco</option>
                                                    <option value="Otro"
                                                        @if (old('etnia') == 'Otro') {{ 'selected' }} @endif>Otro
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="dedicacion" id="dedicacion" class="form-select form-control ">
                                                    ...
                                                    <option value="TC"
                                                        @if (old('dedicacion') == 'TC') {{ 'selected' }} @endif>
                                                        Tiempo Completo</option>
                                                    <option value="MT"
                                                        @if (old('dedicacion') == 'MT') {{ 'selected' }} @endif>Medio
                                                        Tiempo</option>
                                                    <option value="TP"
                                                        @if (old('dedicacion') == 'TP') {{ 'selected' }} @endif>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="correo_personal" type="text" name="correo_personal"
                                                    ...
                                                    value="{{ old('correo_personal') }}" placeholder="Example@gmail.com"
                                                    autofocus>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="direccion" type="text" name="direccion"
                                                    ...
                                                    value="{{ old('direccion') }}" placeholder="Dirección de Domicilio"
                                                    autofocus>
                                                @error('direccion')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="relacion_dependencia" id="relacion_dependencia"
                                                    ...
                                                    <option value="Nombramiento"
                                                        @if (old('relacion_dependencia') == 'Nombramiento') {{ 'selected' }} @endif>
                                                        Nombramiento</option>
                                                    <option value="Contrato"
                                                        @if (old('relacion_dependencia') == 'Contrato') {{ 'selected' }} @endif>
                                                        Contrato</option>
                                                </select>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="relacion_dependencia2" id="relacion_dependencia2"
                                                            ...
                                                            <option value="Titular"
                                                                @if (old('relacion_dependencia2') == 'Titular') {{ 'selected' }} @endif>
                                                                Titular</option>
                                                            <option value="Auxiliar 1"
                                                                @if (old('relacion_dependencia2') == 'Auxiliar 1') {{ 'selected' }} @endif>
                                                                Auxiliar 1</option>
                                                            <option value="Auxiliar 2"
                                                                @if (old('relacion_dependencia2') == 'Auxiliar 2') {{ 'selected' }} @endif>
                                                                Auxiliar 2</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="relacion_dependencia3" id="relacion_dependencia3"
                                                            ...
                                                            <option value="Ocacional"
                                                                @if (old('relacion_dependencia3') == 'Ocacional') {{ 'selected' }} @endif>
                                                                Ocacional</option>
                                                            <option value="Individual"
                                                                @if (old('relacion_dependencia3') == 'Individual') {{ 'selected' }} @endif>
                                                                Individual</option>
                                                            <option value="Honorario"
                                                                @if (old('relacion_dependencia3') == 'Honorario') {{ 'selected' }} @endif>
                                                                Honorario</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="titulo_3_n" type="text" name="titulo_3_n"
                                                    ...
                                                    value="{{ old('titulo_3_n') }}" placeholder="Titulos" autofocus>
                                                @error('titulo_3_n')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="titulo_4_n" type="text" name="titulo_4_n"
                                                    ...
                                                    value="{{ old('titulo_4_n') }}" placeholder="Titulos" autofocus>
                                                @error('titulo_4_n')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="doctorado" type="text" name="doctorado"
                                                    ...
                                                    value="{{ old('doctorado') }}" placeholder="Doctorado" autofocus>
                                                @error('doctorado')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="phd" type="text" name="phd"
                                                    ...
                                                    value="{{ old('phd') }}" placeholder="PHD" autofocus>
                                                @error('phd')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group ">
                                                ...
                                                <select name="discapacidad" id="discapacidad"
                                                    ...
                                                    <option value="No"
                                                        @if (old('discapacidad') == 'No') {{ 'selected' }} @endif>No
                                                    </option>
                                                    <option value="Si"
                                                        @if (old('discapacidad') == 'Si') {{ 'selected' }} @endif>SI
                                                    </option>
                                                </select>
                                                @error('discapacidad')
                                                    <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="col-md-1" id="text_porcentaje" style="display: block;">
                                                <div class="form-group">
                                                    ...
                                                    <input id="porcentaje" type="text" name="porcentaje"
                                                        ...
                                                        value="{{ old('porcentaje') }}" placeholder="%" autofocus>
                                                    @error('porcentaje')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="estado" id="estado" class="form-select form-control "
                                                    ...
                                                    <option value="Activo"
                                                        @if (old('estado') == 'Activo') {{ 'selected' }} @endif>
                                                        Activo</option>
                                                    <option value="Suspendido"
                                                        @if (old('estado') == 'Suspendido') {{ 'selected' }} @endif>
                                                        Suspendido</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-3" id="date_suspendido" style="display: block;">
                                                <div class="form-group">
                                                    ...
                                                    <input id="fecha_suspencion" type="date" name="fecha_suspencion"
                                                        ...
                                                        value="{{ old('fecha_suspencion') }}" autofocus>
